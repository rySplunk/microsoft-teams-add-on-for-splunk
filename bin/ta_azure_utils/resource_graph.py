...
def get_resources_by_query(helper, access_token, query, subscription_id, resources=[]):
...
def get_json_resources_by_query(helper, access_token, query, subscription_ids, resources=[]):
    url = "https://management.azure.com/providers/Microsoft.ResourceGraph/resources?api-version=2019-04-01"
