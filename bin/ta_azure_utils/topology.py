...
def get_topology_by_rg(helper, access_token, subscription_id, api_version, resourceGroupName, networkWatcherName, targetResourceGroupName):
    url = "https://management.azure.com/subscriptions/%s/resourceGroups/%s/providers/Microsoft.Network/networkWatchers/%s/topology?api-version=%s" % (subscription_id, resourceGroupName, networkWatcherName, api_version)
